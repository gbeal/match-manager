...
- [Match Manager Fullstack Architecture Document](#table-of-contents)
  ...
  - [Data Models](./data-models.md)
    ...
    - [Game](./data-models.md#game)
      - [TypeScript Interface](./data-models.md#typescript-interface)
      - [Relationships](./data-models.md#relationships)
    - [Formation](./data-models.md#formation)
      - [TypeScript Interface](./data-models.md#typescript-interface)
      - [Relationships](./data-models.md#relationships)
    - [PlayerGameStatus](./data-models.md#playergamestatus)
      - [TypeScript Interface](./data-models.md#typescript-interface)
      - [Relationships](./data-models.md#relationships)
    - [PlayingTimeRecord](./data-models.md#playingtimerecord)
      - [TypeScript Interface](./data-models.md#typescript-interface)
      - [Relationships](./data-models.md#relationships)
    - [SubstitutionEvent](./data-models.md#substitutionevent)
      - [TypeScript Interface](./data-models.md#typescript-interface)
      - [Relationships](./data-models.md#relationships)
  - [API Specification](./api-specification.md)
    - [REST API Specification](./api-specification.md#rest-api-specification)
  - [Components](./components.md)
    - [PWA Shell Component](./components.md#pwa-shell-component)
    ...
    - [Formation Display Component](./components.md#formation-display-component)
    - [Timer Management Component](./components.md#timer-management-component)
    - [Substitution Alert Component](./components.md#substitution-alert-component)
    - [Strategy Configuration Component](./components.md#strategy-configuration-component)
    - [Future Cloud Sync Component](./components.md#future-cloud-sync-component)
    - [Component Diagrams](./components.md#component-diagrams)
  - [External APIs](./external-apis.md)
    - [Current MVP Status: No External APIs Required](./external-apis.md#current-mvp-status-no-external-apis-required)
    - [Future External API Integrations (Phase 2)](./external-apis.md#future-external-api-integrations-phase-2)
    - [Supabase Authentication API](./external-apis.md#supabase-authentication-api)
    - [Supabase Database API](./external-apis.md#supabase-database-api)
    - [Browser Geolocation API](./external-apis.md#browser-geolocation-api)
    - [Web Push Notifications API (Future)](./external-apis.md#web-push-notifications-api-future)
  - [Core Workflows](./core-workflows.md)
    - [Game Setup and Initialization Workflow](./core-workflows.md#game-setup-and-initialization-workflow)
    - [Real-Time Substitution Alert and Execution Workflow](./core-workflows.md#real-time-substitution-alert-and-execution-workflow)
    - [Playing Time Balance Monitoring Workflow](./core-workflows.md#playing-time-balance-monitoring-workflow)
    - [Offline-First Data Persistence Workflow](./core-workflows.md#offline-first-data-persistence-workflow)
    - [Emergency Substitution and Error Handling Workflow](./core-workflows.md#emergency-substitution-and-error-handling-workflow)
  - [Database Schema](./database-schema.md)
    - [IndexedDB Schema Definition](./database-schema.md#indexeddb-schema-definition)
    - [Schema Relationships and Constraints](./database-schema.md#schema-relationships-and-constraints)
